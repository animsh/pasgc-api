"""
Django settings for pasgc project.
...
SECRET_KEY = 'django-insecure-g0ky+zqg1jh-xa=d^47pw+glva8i%=bd@hnd^@k8iqyebhfkbg'
...
WSGI_APPLICATION = 'pasgc.wsgi.application'
